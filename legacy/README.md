<!-- LEGACY: the pre-migration README, moved here on 2026-09-04 (see ../MIGRATION_AUDIT.md). Relative links below are relative to the repository root, not to legacy/. -->
